...
abstract class WeatherClientRemoteDataSource {
  ...
  Future<List<WeatherClientModel>> getAllWeatherClients(
    GetAllWeatherClientsParams params,
  );

  /// Gets a specific weatherClient by ID from the API
  Future<WeatherClientModel> getWeatherClientById(
    GetWeatherClientParams params,
  );

  Future<WeatherDataModel> getWeatherData(String weatherClientId);

  Future<WeatherClientModel> newWeatherClient(WeatherClientModel weatherClient);

  Future<WeatherClientModel> editWeatherClient(
...
class WeatherClientRemoteDataSourceImpl
  ...
  Future<List<WeatherClientModel>> getAllWeatherClients(
    ...
    try {
      ...
      return response.map((e) => WeatherClientModel.fromJson(e)).toList();
  ...
  Future<WeatherClientModel> getWeatherClientById(
    ...
    try {
      ...
      return WeatherClientModel.fromJson(response);
    } on Exception catch (e) {
      throw _handleException(e);
    }
  }
  ...
  @override
  Future<WeatherDataModel> getWeatherData(String weatherClientId) async {
    try {
      // Check network connection
      final hasNetwork = await AppUtils.hasNetworkConnection();
      if (!hasNetwork) {
  ...
  @override
  Future<WeatherClientModel> newWeatherClient(
    WeatherClientModel weatherClient,
  ) async {
    try {
      // Check network connection
      ...
      return WeatherClientModel.fromJson(weatherClient.toJson());
    } on Exception catch (e) {
      throw _handleException(e);
    }
  }
